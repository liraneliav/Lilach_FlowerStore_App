...
public class testDB {
    ...
    private static void generateStores(List<Product> products){
        ...
        Complain c1 = new Complain("complaint test", "14/07/2022","18:50");
        Complain c2 = new Complain("complaint test", "15/07/2022","17:45");
        Complain c3 = new Complain("complaint test", "15/08/2022","12:12");
